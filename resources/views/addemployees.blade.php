...
<main class="py-4">
  ...
  <button id='openmove' type="button" class="btn btn-primary" onclick='moving("{{route("employee.show")}}", "{{route("employee.update")}}")'>
    {{ __('moving employee') }}
  </button>
          ...
          <div class="col-md-8">
            <div class="card">
              <div class="card-header">
                ...
                <div id='addemp'>{{__('add employee')}}</div>
              </div>
              <div class="card-body">
                <form id='employee' method="POST" action="">
                  ...
                  <p class="d-none" id="tomove">0,1,4,5,6,7</p>
